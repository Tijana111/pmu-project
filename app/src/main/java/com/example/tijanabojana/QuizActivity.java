...
public class QuizActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()) {
                        ...
                        Toast.makeText(QuizActivity.this, "Моля изберете отговор.", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
    ...
    private void showNextQuestion() {
        ...
        if (questionCounter < questionCountTotal) {
            ...
            questionCounter++;
            textViewQuestionCount.setText("Въпрос: " + questionCounter + "/" + questionCountTotal);
            answered = false;
            buttonConfirmNext.setText("Потвърди");
    ...
    private void checkAnswer() {
        ...
        if (answerNr == currentQuestion.getAnswerNr()) {
            score++;
            textViewScore.setText("Резултат: " + score);
        }
    ...
    private void showSolution() {
        ...
        switch (currentQuestion.getAnswerNr()) {
            case 1:
                ...
                //textViewQuestion.setText("Отговор 1 е правилен");
                break;
            case 2:
                rb2.setTextColor(Color.GREEN);
                //textViewQuestion.setText("Отговор 2 е правилен");
                break;
            case 3:
                rb3.setTextColor(Color.GREEN);
                //textViewQuestion.setText("Отговор 3 е правилен");
                break;
        }

        if (questionCounter < questionCountTotal) {
            buttonConfirmNext.setText("Следващ въпрос");
        } else {
            buttonConfirmNext.setText("Край");
        }
    }
    ...
    private void finishQuiz() {
        ...
        textViewEnd = (TextView) findViewById(R.id.text_view_end_score);
        textViewEnd.setText("Резултат: " + score + "/20");
    ...
    public void onBackPressed() {
        if (backPressedTime + 2000 > System.currentTimeMillis()) {
            ...
            Toast.makeText(this, "Натиснете отново, за да завършите", Toast.LENGTH_SHORT).show();
        }
